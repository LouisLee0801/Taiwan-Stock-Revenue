...
請利用你的 Google 搜尋引擎聯網工具，搜尋近期（特別是 2026 年 6 月，接近 {current_date_str} 的這幾天）台灣股市中，各大券商、外資（如大摩、小摩、野村、瑞銀、麥格理、美林等）或本土投信/研究機構「調整個股評等（升評/降評/維持）」與「目標價變更」的最新新聞、研究報告精要與財經網站資料。

⚠️ 重要時間與真實性規定（請嚴格遵守）：
1. 僅收集 **2026 年 6 月份** 最新出爐的評等報告，請絕對不要採信過時的舊聞（例如 2024 年或 2025 年之前的資料）。
2. 請核實目標價必須符合現行 2026 年的市場時空背景。例如：台積電最新股價已在 1000 元以上，聯發科也在 1000 元以上。如果您搜尋到台積電評等目標價為 800 元或 1000 元以下，或者聯發科目標價為 800 元，這明顯是 2024 年或更早的過期舊聞，請「絕對不要」納入！
3. 請務必確認報導發布日期為 2026 年 6 月左右，嚴防歷史資料混淆。
